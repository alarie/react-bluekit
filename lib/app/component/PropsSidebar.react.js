...
var PropsSidebar = (0, _radium2.default)(_class = (_temp2 = _class2 = function (_Component) {
  ...
  _createClass(PropsSidebar, [{
    ...
    value: function render() {
      ...
      var toggleProps = _context.toggleProps;
      var setSourceBackground = _context.setSourceBackground;
      var _props = this.props;
      var atom = _props.atom;
      var currentProps = _props.currentProps;
      ...
      var activeProps = _state.activeProps;
      var displayColorPicker = _state.displayColorPicker;
      var dropdownOpened = _state.dropdownOpened;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          atom.get('description') ? _react2.default.createElement('div', {
            dangerouslySetInnerHTML: { __html: atom.get('description').replace(/\n/g, '<br />') },
            style: _extends({}, styles.description, styles.clearfix)
          }) : null,
          _react2.default.createElement(
            'div',
...
var styles = {
  ...
  description: _extends({}, _Headings2.default, {
    fontSize: '14px',
    padding: '0 ' + _Spaces2.default.normal,
    color: '#888888',
    marginBottom: '30px'

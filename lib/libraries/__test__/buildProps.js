...
(0, _ava2.default)('build props', function (t) {
  ...
  var arrayOfProps = [builtProps.arrayOfProp instanceof Array, _typeof(builtProps.objectProp) === 'object', builtProps.nodeProp === 'NODE nodeProp', typeof builtProps.funcProp === 'function', typeof builtProps.numberProp === 'number' && builtProps.numberProp === 1, builtProps.stringPropDefault === '\'text\'', builtProps.boolProp === true || false, typeof builtProps.enumProps === 'string', _typeof(builtProps.shapeProps) === 'object', builtProps.anyProp === 'ANY anyProp', builtProps.stringProp === 'stringProp', builtProps.stringPropDefaultFalse === 'text', builtProps.arrayProp instanceof Array];
